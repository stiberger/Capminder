...
var QueryToolbar = Backbone.View.extend({
    ...
    switch_render_button: function(event) {
        ...
        //stiberger: Changed to be able to add renderers.
            ...
            //@todo should do som checking first
            //@todo Should maybe have fallback to table rendering
    ...
    switch_render: function(render_type) {
        ...
        if ("chart" == render_type) {
            //Stiberger: instead of toggling between cart and table -
            //Hide all options, for then to display chart options
            $(this.el).find('ul.options').hide();
            ...
            //Stiberger: Hide all options, for then to display table options
            $(this.el).find('ul.options').hide();
            $(this.el).find('ul.table').show();
    ...
    call: function(event) {
        ...
        if (!$target.hasClass('disabled_toolbar')) {
            ...
            //Stiberger: Added to be able to put options in other renderers.
